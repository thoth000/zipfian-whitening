...
class SE(object):
    def __init__(self, params, batcher, prepare=None, whitening_calculator=None):
        # parameters
    ...
    def eval(self, name):
        ...
        if name == "CR":
            ...
            self.evaluation = SICKRelatednessEval(
                tpath + "/downstream/SICK",
                seed=self.params.seed,
                whitening_calculator=self.whitening_calculator,
            )
        elif name == "STSBenchmark":
            self.evaluation = STSBenchmarkEval(
                tpath + "/downstream/STS/STSBenchmark",
                seed=self.params.seed,
                whitening_calculator=self.whitening_calculator,
            )
        elif name == "STSBenchmark-fix":
            self.evaluation = STSBenchmarkEval(
                tpath + "/downstream/STS/STSBenchmark-fix",
                seed=self.params.seed,
                whitening_calculator=self.whitening_calculator,
            )
